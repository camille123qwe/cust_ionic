...
export class SignInPage {
  ...
  qiandao() {
    ...
    this.http.httpMethodContext(HttpUrl.qiandao, data, (res, context) => {
      if (res.retcode == 0) {
        ...
        let myModal = context.modalCtrl.create('SignInSucceedPage',{'data':res.awarddetail,'type':'sign'});
        myModal.present();
        context.mycheckinfo();
      } else {
  ...
  goTurntable() {
    ...
    this.navCtrl.push('TurntablePage', { 'gift': this.giftName, 'restcdrcount': this.jihui ,'gifImg':this.gifImg})
  }
