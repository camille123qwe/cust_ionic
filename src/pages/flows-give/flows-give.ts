...
import {  NavController, NavParams, App, AlertController, ModalController, ViewController } from 'ionic-angular';
import { HttpGet } from '../../providers/http-get';
import { HttpContents, HttpUrl, showToast, constVar, isLogin, goLogin } from '../../common/global';
import { GlobalProvider } from '../../providers/global-provider';
import { ChargeSuccessPage } from '../charge-success/charge-success';
import { GiveflowsSuccess } from '../giveflows-success/giveflows-success';
/**
 * Generated class for the FlowsGive page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
@Component({
  selector: 'page-flows-give',
  templateUrl: 'flows-give.html',
})
export class FlowsGivePage {
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.http.httpMethodContext(HttpUrl.payFlux, dataParams, (res, context) => {
              console.log(res);
              if (res.retcode == 0) {
                context.needlogin = false;
                this.presentModal();
              } else if(res.retcode==30020007){
                context.needlogin = true;
                this.presentModal();
              }else {
  ...
  presentModal() {
     this.navCtrl.push(GiveflowsSuccess,{
       needlogin:this.needlogin,
       mobile:this.charge_number,
       custuserid:this.custuserid,
       commonkbs:this.commonkbs
     });
  }
