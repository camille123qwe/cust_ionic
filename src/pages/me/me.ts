...
import { MyFlowsPage } from '../my-flows/my-flows';
...
import { OrderOfGoodsPage } from "../order-of-goods/order-of-goods";
...
export class MePage {
  ...
  unread_count = 0;
  unread_show = false;
  setting='assets/img/icon_gerenshezhi@2x.png'
  constructor(private navCtrl: NavController, public navParams: NavParams, public alertCtrl: AlertController, public globalProvider: GlobalProvider,
    public actionSheetCtrl: ActionSheetController, private http: HttpGet, private app: App,private Imagepicker:ImagePicker,private camera:Camera,
  ...
  onSuccess(res, context) {
    ...
    //test data
    // context.col1_value = "12";
    // context.col2_value = "3000";
    // context.col3_value = "90分钟";
    // context.user_name = "红柚子";
