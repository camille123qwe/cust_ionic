...
/**
 * Generated class for the FlowsCharge page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
 @Component({
  selector: 'page-flows-charge',
  templateUrl: 'flows-charge.html',
})

export class FlowsChargePage {
  ...
  presentModal() {
    let modal = this.modalCtrl.create(ChargeSuccessPage);
    modal.present();
  }
}
